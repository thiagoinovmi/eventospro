...
class DataRowsTableSeeder extends Seeder
{
    ...
    protected function categories()
    {
        ...
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "image", "display_name" => "Thumb (256x256 px)", "required" => 0, "browse" => 1, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "validation" => [
                "rule" => "nullable" 
            ], 
        "resize" => [
        ...
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "image", "display_name" => "Icon (128x128 px)", "required" => 0, "browse" => 1, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "validation" => [
                "rule" => "nullable" 
            ], 
        "resize" => [
        ...
        "description" => "Upload a transparent icon image. The icon should be of white color.",
        "quality" => "70%", 
        "upsize" => true 
        ], "order" => 4, ])->save();
        }
    ...
    protected function banners()
    {
        ...
        $dataRow = $this->dataRow($DataType, "title");
        if (true) {
            $dataRow->fill(["type" => "text", "display_name" => "Title", "required" => 0, "browse" => 0, "read" => 0, "edit" => 0, "add" => 0, "delete" => 0, "details" => [
        "validation" => [
                "rule" => "max:128" 
            ] 
        ], "order" => 2, ])->save();
        ...
        if (true) {
            $dataRow->fill(["type" => "text", "display_name" => "Subtitle", "required" => 0, "browse" => 0, "read" => 0, "edit" => 0, "add" => 0, "delete" => 0, "details" => [
        "validation" => [
                "rule" => "max:256" 
            ] 
        ], "order" => 3, ])->save();
        ...
        if (true) {
            $dataRow->fill(["type" => "text", "display_name" => "Banner URL", "required" => 0, "browse" => 1, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => "{}", "order" => 4, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "button_title");
        if (true) {
            $dataRow->fill(["type" => "text", "display_name" => "Button Title", "required" => 0, "browse" => 0, "read" => 0, "edit" => 0, "add" => 0, "delete" => 0, "details" => "{}", "order" => 4, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "order");
        if (true) {
            $dataRow->fill(["type" => "number", "display_name" => "Banner Sequence Number (starting from 0)", "required" => 0, "browse" => 1, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => "{}", "order" => 4, ])->save();
        }
    }
    ...
    protected function tags()
    {
        ...
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "X", "required" => 0, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "validation" => [
                "rule" => "nullable" 
            ], 
        "placeholder" => "Fill this only if you selected Profile Page - Yes" 
