...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="blogDropdown">
        ...
        @if (Auth::user()->hasRole('pos'))
            <li class="nav-item dropdown">
                <a class="dropdown-item" href="{{ route('eventmie.pos.o_dashboard') }}"><i
                        class="fas fa-tachometer-alt"></i> @lang('eventmie-pro::em.dashboard')</a>
            </li>
        @endif
        ...
        @if (Auth::user()->hasRole('scanner'))
            <li class="nav-item dropdown">
                <a class="dropdown-item" href="{{ route('eventmie.scanner.o_dashboard') }}"><i
                        class="fas fa-tachometer-alt"></i> @lang('eventmie-pro::em.dashboard')</a>
            </li>
        @endif
...
{{-- Organiser or Admin Scanner --}}
@if (Auth::user()->hasRole(['organiser', 'admin']))
    <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="javascript:void(0)" id="blogDropdown" role="button"
            data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-qrcode"></i>
            @lang('eventmie-pro::em.scan_ticket') <i class="fas fa-caret-down"></i>
        </a>
        <ul aria-labelledby="blogDropdown" class="dropdown-menu">
            <li class="nav-item dropdown">
                <a class="dropdown-item" href="{{ route('eventmie.scan_ticket_camera') }}">
                    <i class="fas fa-qrcode"></i>
                    @lang('eventmie-pro::em.camera_ticket_scanner')
                </a>
            </li>

            <li class="nav-item dropdown">
                <a class="dropdown-item" href="{{ route('eventmie.scan_ticket_laser') }}">
                    <i class="fas fa-barcode"></i>
                    @lang('eventmie-pro::em.laser_ticket_scanner')
                </a>
            </li>
        </ul>
    </li>
