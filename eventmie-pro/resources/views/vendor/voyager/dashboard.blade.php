                                    ...
                                    <form>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="searchInput"
                                                oninput="searchOptions('searchInput', 'event_id')"
                                            ...
                                            <select class="form-control" name="event_id" id="event_id" size="7">
                                                ...
                                                @foreach ($events as $key => $value)
                                                    <option value="{{ $value['id'] }}" {{ $key === 0 ? 'selected' : '' }}> {{ $value['title'] }} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                 ...
                                 <form>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="searchInput1"
                                            oninput="searchOptions('searchInput1', 'event_id_ticket_stats')"
...
@section('javascript')
    ...
    document.addEventListener("DOMContentLoaded", function() { 
        ...
        window.searchOptions = function(input_id, dropdown_id) {
            ...
            var url = {!! json_encode(route('eventmie.search_events')) !!};
            
            // Make an AJAX request to your server
            fetch(`${url}?event_title=${encodeURIComponent(event_title)}`)
                ...
                .then(data => {
                    ...
                    if (data.length > 0) {
                        ...
                        // Trigger change event to reload the table
                        ...
                        myDropdown.appendChild(option);
                        // Also trigger change to clear the table
                        $(myDropdown).trigger('change');
                    }
                    ...
                    // If you want to trigger table reloads or other actions after search:
                    if (dropdown_id === 'event_id') {
                        if ($.fn.DataTable.isDataTable('#sales_report')) {
                            $('#sales_report').DataTable().destroy();
                        }
                        if ($.fn.DataTable.isDataTable('#event_total')) {
                            $('#event_total').DataTable().destroy();
                        }
                        sales_report();
                        events_total_by_sales_price();
