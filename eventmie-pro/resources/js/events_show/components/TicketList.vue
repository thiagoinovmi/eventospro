                        ...
                        <form ref="form" @submit.prevent="validateForm" method="POST" >
                            ...
                            <div class="">
                                                ...
                                                <div class="d-flex justify-content-between lh-condensed d-flex-wrap">
                                                    ...
                                                    <div class="w-20">
                                                        ...
                                                        <div v-else>
                                                            ...
                                                            <!-- Show if vacant less than max_ticket_qty -->
                                                            <p class="text-primary h6 text-nowrap" 
                                ...
                                <div class="row" v-if="bookedTicketsTotal() > 0 && login_user_id">
                                    <div class="col-12 payment-options mb-3">
                                        <div class="border rounded border-1 border-dark list-group-flush px-2 bg-white">
                                            <!-- Free -->
                                            <div class="d-block my-3 pl-3" v-if="total <= 0">
                                                <div class="radio-inline">
                                                    ...
                                                    <label class="custom-control-label" for="free_order"> &nbsp;<i class="fas fa-glass-cheers"></i> {{ trans('em.free') }}</label>
                                                </div>
                                            </div>
