...
class InstallCommand extends Command
{
    ...
    public function handle(Filesystem $filesystem)
    {
        ...
        $this->info('Installing Eventmie Pro...');
    ...
    private function install(Filesystem $filesystem)
    {
        ...
        // 4. Dump autoload
        $this->info('4. Dumping the autoloaded files and reloading all new files');
        ...
        // 5. Add Eventmie Route
        $this->info('5. Adding Eventmie Pro routes to your application routes/web.php');
        ...
        $this->info('6. Running Eventmie Pro database seeders');
        $this->seed('EventmieDatabaseSeeder');
        
        // 7. Copy missing extras folder's files to storage
        $this->info('7. Adding Placeholders');
