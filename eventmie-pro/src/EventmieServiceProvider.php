...
class EventmieServiceProvider extends ServiceProvider
{
    ...
    {
        // set openai api key
        $openai_api_key = setting('ai.openai_api_key') ?: env('OPENAI_API_KEY', false);
    ...
    */
    ...
    private function loadMiddlewares()
    {
        ...
        $this->app['router']->aliasMiddleware('pos', \Classiebit\Eventmie\Middleware\Pos::class);
        $this->app['router']->aliasMiddleware('pos_user_only', \Classiebit\Eventmie\Middleware\OnlyPos::class);
        $this->app['router']->aliasMiddleware('scanner', \Classiebit\Eventmie\Middleware\Scanner::class);
    }
    ...
    private function registerPublishableResources()
    {
        ...
        $publishable        = [
            'eventmie-pro-config' => [
                ...
                "{$publishablePath}/config/openai.php" => config_path('openai.php'),
