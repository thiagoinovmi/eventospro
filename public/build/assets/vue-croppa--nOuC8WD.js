import { d as commonjsGlobal, g as getDefaultExportFromCjs } from "./vue_common-BHhurHzD.js";
var vueCroppa$1 = { exports: {} };
var vueCroppa = vueCroppa$1.exports;
var hasRequiredVueCroppa;
function requireVueCroppa() {
  if (hasRequiredVueCroppa) return vueCroppa$1.exports;
  hasRequiredVueCroppa = 1;
  (function(module, exports) {
    (function(global, factory) {
      ...
      var canvasExifOrientation = createCommonjsModule(function(module2, exports2) {
      ...
      var u = {
        onePointCoord: function onePointCoord(point, vm) {
          var canvas = vm.canvas, quality = vm.quality;
        ...
        getFileOrientation: function getFileOrientation(arrayBuffer) {
          ...
          if (view.getUint16(0, false) != 65496) return -2;
          ...
          while (offset < length) {
            ...
            offset += 2;
            if (marker == 65505) {
              if (view.getUint32(offset += 2, false) != 1165519206) return -1;
      ...
      var PCT_PER_ZOOM = 1 / 1e5;
      var MIN_MS_PER_CLICK = 500;
      var CLICK_MOVE_THRESHOLD = 100;
      var MIN_WIDTH = 10;
      var DEFAULT_PLACEHOLDER_TAKEUP = 2 / 3;
      var PINCH_ACCELERATION = 1;
      ...
      var component = {
        render: function render() {
          ...
          return _c("div", { ref: "wrapper", class: "croppa-container " + (_vm.img ? "croppa--has-target" : "") + " " + (_vm.passive ? "croppa--passive" : "") + " " + (_vm.disabled ? "croppa--disabled" : "") + " " + (_vm.disableClickToChoose ? "croppa--disabled-cc" : "") + " " + (_vm.disableDragToMove && _vm.disableScrollToZoom ? "croppa--disabled-mz" : "") + " " + (_vm.fileDraggedOver ? "croppa--dropzone" : ""), on: { "dragenter": function dragenter($event) {
            ...
            $event.stopPropagation();
            return _vm._handlePointerStart($event);
            ...
            $event.stopPropagation();
            return _vm._handlePointerMove($event);
            ...
            $event.stopPropagation();
            $event.preventDefault();
            return _vm._handlePointerLeave($event);
        ...
        watch: {
          ...
          "imgData.width": function imgDataWidth(val, oldVal) {
            ...
            if (this.hasImage()) {
              if (Math.abs(val - oldVal) > val * (1 / 1e5)) {
        ...
        methods: {
          ...
          zoom: function zoom() {
            var zoomIn = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
            var acceleration = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1;
            if (this.passive) return;
          ...
          getMetadata: function getMetadata() {
            if (!this.hasImage()) return {};
            var _imgData = this.imgData, startX = _imgData.startX, startY = _imgData.startY;
            return {
              startX,
              startY,
          ...
          _setImagePlaceholder: function _setImagePlaceholder() {
            ...
            if (this.$slots.placeholder && this.$slots.placeholder[0]) {
              ...
              var tag = vNode.tag, elm = vNode.elm;
              if (tag == "img" && elm) {
                img = elm;
              }
            }
          ...
          _onload: function _onload(img) {
            var orientation = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1;
          ...
          _onVideoLoad: function _onVideoLoad(video, initial) {
            ...
            var ctx = canvas.getContext("2d");
            this.loading = false;
            var drawFrame = function drawFrame2(initial2) {
            ...
            drawFrame(true);
            var keepDrawing = function keepDrawing2() {
              _this5.$nextTick(function() {
                drawFrame();
                if (!_this5.video || _this5.video.ended || _this5.video.paused) return;
                requestAnimationFrame(keepDrawing2);
              });
            };
          ...
          _onNewFileIn: function _onNewFileIn(file) {
            ...
            if (!this._fileTypeIsValid(file)) {
              ...
              file.type || file.name.toLowerCase().split(".").pop();
              return false;
            }
          ...
          _handlePointerEnd: function _handlePointerEnd(evt) {
            ...
            if (this.disabled) return;
            if (!this.hasImage() && !this.disableClickToChoose) {
              var tabEnd = (/* @__PURE__ */ new Date()).valueOf();
          ...
          _setOrientation: function _setOrientation() {
            var _this8 = this;
            var orientation = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 6;
          ...
          _drawFrame: function _drawFrame() {
            ...
            this.loading = false;
            var ctx = this.ctx;
            var _imgData2 = this.imgData, startX = _imgData2.startX, startY = _imgData2.startY, width = _imgData2.width, height = _imgData2.height;
            this._paintBackground();
          ...
          _applyMetadata: function _applyMetadata() {
            ...
            var _userMetadata = this.userMetadata, startX = _userMetadata.startX, startY = _userMetadata.startY, scale = _userMetadata.scale;
  ...
  return vueCroppa$1.exports;
}
var vueCroppaExports = requireVueCroppa();
const Croppa = /* @__PURE__ */ getDefaultExportFromCjs(vueCroppaExports);
export {
  Croppa as C
};
//# sourceMappingURL=vue-croppa--nOuC8WD.js.map
