import { g as getDefaultExportFromCjs, n as normalizeComponent, m as mixinsFilters, a as axios } from "./mixins-DZWn0auj.js";
...
var _sfc_render = function render() {
  ...
  }), _c("div", { staticClass: "scanner-customer-block" }, [_c("div", { staticClass: "scanner-customer-badge" }, [_vm._v(_vm._s(_vm.trans("em.buyer")))]), _c("div", { staticClass: "scanner-customer-name text-dark" }, [_vm._v(_vm._s(_vm.resultData.customer_name))]), _c("div", { staticClass: "scanner-customer-email text-dark" }, [_vm._v(_vm._s(_vm.resultData.customer_email))])]), _vm.resultType === "warning" ? _c("div", { staticClass: "d-flex justify-content-center mt-3" }, [_c("button", { staticClass: "btn btn-secondary px-4 py-2", on: { "click": _vm.refreshPage } }, [_c("i", { staticClass: "fas fa-sync-alt me-2" }), _vm._v(_vm._s(_vm.trans("em.scan_another_ticket")) + " ")])]) : _vm._e()] : [_c("div", { staticClass: "scanner-error-message" }, [_vm._v(" ")]), _c("div", { staticClass: "scanner-event-header" }, [_c("i", { staticClass: "fas fa-ban" }), _vm._v(" " + _vm._s(_vm.resultMessage) + " ")])]] : _vm._e()], 2) : _c("div", { staticClass: "row scanner-wrapper" }, [_c("div", { staticClass: "col-12", staticStyle: { "height": "90vh" } }, [!_vm.is_laser && _vm.hide_scanner <= 0 ? _c("qrcode-stream", { attrs: { "camera": _vm.camera }, on: { "decode": _vm.getOrderNumberFromQRCode, "init": _vm.onInit } }) : _vm._e(), _vm.is_laser ? _c("input", { directives: [{ name: "model", rawName: "v-model", value: _vm.laser_scanner, expression: "laser_scanner" }], ref: "laserInput", staticClass: "form-control", attrs: { "placeholder": _vm.trans("em.scan_ticket_on_laser"), "autofocus": "" }, domProps: { "value": _vm.laser_scanner }, on: { "change": _vm.getOrderNumberFromLaserInput, "blur": _vm.focusLaserInput, "input": function($event) {
...
//# sourceMappingURL=index-BVyFZdCV.js.map
